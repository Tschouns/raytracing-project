...
namespace RayTracing.Rendering.Cameras
{
    ...
    {
        private static readonly Vector2 defaultSize = new(0.008f, 0.006f);
        ...
        private static readonly Vector3 defaultPosition = new(0, 0, -10);
        private static readonly Vector3 defaultLookingDirection = new(0, 0, 1);
            ...
            ushort verticalResolution)
        {
            ...
            var ratio = (float)horizontalResolution / this.VerticalResolution;
